...
Usage:
  python evaluate_gold.py ../../../resources/golden-standard/original ../../../resources/golden-standard/modern \
      --rules ../rules/rules.tsv --lexicon ../../../resources/ordbøger/aaTilÅ/ddo_DDO \
      --out ../../../resources/golden-standard/eval_results.json
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=Path("../../../resources/golden-standard/eval_results.json"))
